...
/**
 * Temporary class, waiting for the CAS 5.3.x to implement the new one
 * 
 * @author Francis Le Coq
 * @since 5.2
 */
public class DefaultClaExternalIDRegisteredServiceAccessStrategy implements RegisteredServiceAccessStrategy {

    private static final long serialVersionUID = 1245279151345635245L;
    private static final Logger LOGGER = LoggerFactory.getLogger(DefaultClaExternalIDRegisteredServiceAccessStrategy.class);
     ...
     */
    public DefaultClaExternalIDRegisteredServiceAccessStrategy() {
        this(true, true);
    }
     ...
     */
    public DefaultClaExternalIDRegisteredServiceAccessStrategy(final boolean enabled, final boolean ssoEnabled) {
     ...
     */
    public DefaultClaExternalIDRegisteredServiceAccessStrategy(final Map<String, Set<String>> requiredAttributes,
    ...
    public boolean equals(final Object obj) {
        ...
        final DefaultClaExternalIDRegisteredServiceAccessStrategy rhs = (DefaultClaExternalIDRegisteredServiceAccessStrategy) obj;
